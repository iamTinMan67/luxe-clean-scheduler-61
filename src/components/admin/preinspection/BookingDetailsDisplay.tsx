...
const BookingDetailsDisplay = ({ bookingDetails }: BookingDetailsDisplayProps) => {
  ...
  return (
    <div className="p-3 bg-black/30 rounded-md border border-gold/20 mt-4 relative">
      {/* Delete Button */}
      <DeleteBookingButton booking={bookingDetails} />
      
      <div className="grid grid-cols-2 gap-2 text-sm pr-10">
